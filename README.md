...
## 用户名爆破
    ffuf -request req.txt -w 用户名字典.txt -mr '密码错误' -t 800 -H "Accept-Encoding: identity" -s > data.txt
## 账号密码爆破
    ffuf -request req.txt -w username.txt:USERNAME -w password.txt:PASSWORD -mr '200' -t 800 -H "Accept-Encoding: identity"
